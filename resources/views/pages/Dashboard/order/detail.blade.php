                    ...
                    <div class="bg-white rounded-xl">
                        <section class="pt-6 pb-20 mx-8 w-auth">
                            <div class="grid gap-5 md:grid-cols-12">
                                            ...
                                            <div class="flex mt-2 flex-nowrap">
                                                @forelse ($thumbnail as $thumb)
                                                    <img :class="{ 'border-4 border-serv-button': active === {{ $thumb->id }} }"
                                                        ...
                                                        src="{{ url(Storage::url($thumb->thumbnail)) }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="leading-8 text-md">
                                                ...
                                                <ul class="mb-4 list-check">
                                                    @forelse ($advantageService as $as)
                                    ...
                                    <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                                        ...
                                        <div class="px-4 pt-4 pb-2 features-list">
                                            <ul class="mb-4 text-sm list-check">
                                                @forelse ($advantageUser as $au)
                                                    <li class="pl-10 my-4">{{ $au->advantage }}</li>
                                                @empty
                                                    {{-- empty --}}
                                                @endforelse
                                            </ul>
                                ...
                                <ul class="p-4 lg:col-span-6 md:col-span-12">
