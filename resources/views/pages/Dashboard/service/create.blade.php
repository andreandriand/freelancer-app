                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 -mb-6">
                                            <label for="estimation and revision limit"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <input placeholder="Maksimal Revisi service kamu" type="number"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                value="{{ old('revision_limit') }}" required>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addThumbnailRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan 3" type="file" name="thumbnail[]" id="thumbnail" autocomplete="thumbnail" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
